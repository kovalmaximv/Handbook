...
1. [Репликация](#репликация)
2. [Ведущие и ведомые узлы](#ведущие-и-ведомые-узлы)  
   2.1. [Синхронность репликаций](#синхронность-репликаций)  
   2.2. [Создание новые ведомых узлов](#создание-новых-ведомых-узлов)  
   2.3. [Перебои в обслуживании узлов](#перебои-в-обслуживании-узлов)  
   2.4. [Журналы репликации](#журналы-репликации)  
3. [Проблемы задержки репликации](#проблемы-задержки-репликации)  
4. [Репликации с несколькими ведущими узлами](#репликации-с-несколькими-ведущими-узлами)
   4.1. [Обработка конфликтов записи](#обработка-конфликтов-записи)  
5. [Репликация без ведущего узла](#репликация-без-ведущего-узла)
6. [Итог](#итог)
