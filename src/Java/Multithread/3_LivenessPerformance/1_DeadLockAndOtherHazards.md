...
3. [Предотвращение и диагностирование взаимной блокировки](#Предотвращение-и-диагностирование-взаимной-блокировки)
   3.1. [Хронометрированные замки](#Хронометрированные-замки)  
   3.2. [Поточные дампы JVM](#Поточные-дампы-JVM)  
4. [Другие сбои жизнеспособности](#Другие-сбои-жизнеспособности)
   4.1. [Голодание](#Голодание)  
   4.2. [Активная блокировка](#Активная-блокировка)  
5. [Итоги](#Итоги)
