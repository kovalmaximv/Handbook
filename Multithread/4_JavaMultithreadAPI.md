...
> :exclamation: **Конкурентные коллекции предоставляют лучшую масштабируемость и быстродействие, при небольшом риске в
> потокобезопасности.**

#### ConcurrentHashMap
Класс ConcurrentHashMap - хешированный ассоциативный массив Map (почти как HashMap), но использующий 
замковое расщепление на полосы (_lock striping_, см в следующих главах), вместо синхронизации методов. 
