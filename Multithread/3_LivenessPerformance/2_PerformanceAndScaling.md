...
Чтобы увидеть, какая доля последовательности скрыта в приложении, можно добавлять ресурсы и анализировать изменения 
...
N защищена `N mod 16` замком. Таким образом шанс конфликта блокировки уменьшет приблизительно в 16 раз (на самом деле 
чуть меньше). 
